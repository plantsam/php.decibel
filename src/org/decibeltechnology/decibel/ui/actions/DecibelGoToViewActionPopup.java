 ...
 */
public class DecibelGoToViewActionPopup {
    ...
    public DecibelGoToViewActionPopup(List<FileObject> views, int offset) {
        this.views = views;
        this.offset = offset;
    }
    ...
    private void showPanel() {
        ...
        JComponent content = new DecibelGoToViewActionPanel(views, this);
